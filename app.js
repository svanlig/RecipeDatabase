...
/*
 * Native <datalist> matches only against the
 * entire input value, so it cannot suggest a
 * tag after a comma on its own.
 *
 * To support "Korean, chick" we intercept the
 * input event, split the value on the last
 * comma, and rebuild the datalist so that
 * every option is prefixed with the text up
 * to and including that comma.
 *
 * The browser's native prefix match then
 * suggests the correct tag for the fragment
 * the user is currently typing.
 *
 * The user's actual input value is never
 * rewritten.
 */
...
document.addEventListener(
    ...
    function(event) {
        ...
        /*
         * No comma yet: leave the datalist
         * populated with bare tag names.
         */
        ...
        /*
         * Collect unique tag names the same
         * way populateTagSuggestions() does,
         * but do it here so we do not alter
         * that function's output shape.
         */
